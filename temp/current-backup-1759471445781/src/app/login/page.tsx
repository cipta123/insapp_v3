      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="relative bg-white/95 backdrop-blur-sm rounded-2xl shadow-xl border border-blue-100 p-8">
          ...
          <div className="text-center mb-8">
            <div className="inline-flex items-center justify-center w-20 h-20 bg-white rounded-full mb-4 shadow-lg border-4 border-blue-100">
              <Image 
                src="/logo-ut.png" 
            ...
            <h1 className="text-3xl font-bold text-gray-800 mb-2">UT Serang</h1>
            <p className="text-gray-600">Customer Service System Dashboard</p>
          </div>
          ...
          <div className="mt-6 text-center">
            <p className="text-gray-600 text-sm">
              Universitas Terbuka Customer Service System
            </p>

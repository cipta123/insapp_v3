        ...
        {selectedPost ? (
              ...
              <div className="flex items-center justify-between">
                <div>
                  <h3 className="text-lg font-semibold text-gray-900">
                    {selectedPost.caption ? selectedPost.caption.slice(0, 60) + '...' : `Post ${selectedPost.postId.slice(-6)}`}
                  </h3>
                  <p className="text-sm text-gray-500 mt-1">
                    {getPostComments(selectedPost.postId).length} comments • {formatTime(selectedPost.timestamp)}
                  </p>
                </div>
          ...
          <div className="flex-1 flex items-center justify-center bg-gray-50">
            <div className="text-center">
              ...
              <p className="text-gray-500">Choose a post from the left to view and manage its comments</p>
            </div>
          </div>
        )}
      </div>

      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="relative bg-white/10 backdrop-blur-xl rounded-2xl shadow-2xl border border-white/20 p-8">
          ...
          <div className="text-center mb-8">
            <div className="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-r from-purple-600 to-blue-600 rounded-full mb-4 animate-bounce">
              <Star className="w-8 h-8 text-white" />
            </div>
            <h1 className="text-3xl font-bold text-white mb-2">Welcome Back</h1>
            <p className="text-gray-300">Sign in to your customer service dashboard</p>
          </div>
            ...
            <div className="relative">
              ...
              <div className="relative">
                <button
                  ...
                  className="w-full bg-white/10 border border-white/20 rounded-lg px-4 py-3 text-left text-white hover:bg-white/20 transition-all duration-200 flex items-center justify-between"
                >
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <div className="text-xs text-gray-300">{selectedRole.description}</div>
                    </div>
                  </div>
                ...
                {/* Role Dropdown */}
                {showRoleDropdown && (
                  <div className="absolute top-full left-0 right-0 mt-2 bg-white/10 backdrop-blur-xl border border-white/20 rounded-lg shadow-2xl z-10 overflow-hidden">
                    {userRoles.map((role) => (
                      <button
                        key={role.id}
                        type="button"
                        ...
                        className="w-full px-4 py-3 text-left hover:bg-white/20 transition-all duration-200 flex items-center space-x-3 text-white"
                      >
